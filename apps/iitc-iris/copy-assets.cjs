...
copyOptionalFixture(path.join(__dirname, '../../docs/iris/update-map-samples/get-entities-z10.json'), path.join(fixtureDir, 'get-entities-z10.json'));
copyOptionalFixture(path.join(__dirname, '../../docs/iris/update-map-samples/get-entities-z14.json'), path.join(fixtureDir, 'get-entities-z14.json'));
copyOptionalFixture(path.join(__dirname, '../../docs/iris/update-map-samples/get-entities-damrak-iitc-z15.json'), path.join(fixtureDir, 'get-entities-damrak-iitc-z15.json'));
