...
import { ExportPopup } from '../../../../packages/plugins/src/export-data/ExportPopup';
import { ThemePopup } from '../../../../packages/plugins/src/theme-selector/ThemePopup';
...
function toViewportPerformanceSnapshot(snapshot: Record<string, unknown>): MapPerfSnapshot {
    ...
    return {
        ...
        sourceSyncCount: getOptionalNumber('sourceSyncCount'),
        movingSourceSyncCount: getOptionalNumber('movingSourceSyncCount'),
        sourceUpdateCount: getOptionalNumber('sourceUpdateCount'),
        sourceUpdateSetDataMs: getOptionalNumber('sourceUpdateSetDataMs'),
        sourceUpdateSkippedUnchangedCount: getOptionalNumber('sourceUpdateSkippedUnchangedCount'),
        movingSourceUpdateCount: getOptionalNumber('movingSourceUpdateCount'),
        movingSourceUpdateSetDataMs: getOptionalNumber('movingSourceUpdateSetDataMs'),
        movingSourceUpdateSkippedUnchangedCount: getOptionalNumber('movingSourceUpdateSkippedUnchangedCount'),
        sourceUpdateCallCounts: toRecordOfNumbers(snapshot.sourceUpdateCallCounts),
        sourceUpdateCallMs: toRecordOfNumbers(snapshot.sourceUpdateCallMs),
        sourceUpdateCallMaxMs: toRecordOfNumbers(snapshot.sourceUpdateCallMaxMs),
        sourceUpdateCallMaxAt: toRecordOfNumbers(snapshot.sourceUpdateCallMaxAt),
        sourceUpdateSkippedUnchangedCounts: toRecordOfNumbers(snapshot.sourceUpdateSkippedUnchangedCounts),
        sourceUpdateReasons: toRecordOfNumbers(snapshot.sourceUpdateReasons),
        sourcePassId: getOptionalNumber('sourcePassId'),
        sourcePassStartedAt: getOptionalNumber('sourcePassStartedAt'),
        sourcePassReason: typeof snapshot.sourcePassReason === 'string' ? snapshot.sourcePassReason : undefined,
        sourcePassMoving: typeof snapshot.sourcePassMoving === 'boolean' ? snapshot.sourcePassMoving : undefined,
        sourcePassSourceCount: getOptionalNumber('sourcePassSourceCount'),
        sourcePassSetDataCalls: getOptionalNumber('sourcePassSetDataCalls'),
        sourcePassSkippedUnchangedCount: getOptionalNumber('sourcePassSkippedUnchangedCount'),
        sourcePassSetDataMs: getOptionalNumber('sourcePassSetDataMs'),
        sourcePassMaxSetDataMs: getOptionalNumber('sourcePassMaxSetDataMs'),
