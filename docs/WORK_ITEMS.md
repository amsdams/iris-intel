...
| Audit remaining non-UI shared runtime candidates              | Open        | keep as an audit list, not an extraction mandate: portal detail level/resonator derivation, live topology freshness tuning, mock data generators, remaining app-specific extension protocol builders, and any request/data helpers that gain a second concrete call site                                                                                                                                                                                                                            |
