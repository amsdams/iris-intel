...
| Polish secondary overlay styling in page-world mode                      | Open   | compare mission routes/waypoints, plugin GeoJSON, plugin labels, and planned items against old `MapOverlay`/IITC expectations; artifacts and ornaments have had first-pass ring polish |
