...
| Extract shared portal history semantics                       | Done        | moved visited/captured/scanned history keys, overlay modes, mode cycling, persisted-mode validation, overlay flag derivation, and All/Yes/No filter matching into `packages/core`; Mini-IRIS still owns ring rendering while IRIS keeps tactical hide/show filter UI                                                                                                                                                                                                                                 |
