...
| Audit remaining page-map protocol overlap                     | Open        | compare IRIS and Mini page-world command/event protocols for stable shared primitives beyond camera/bounds/benchmark modes; avoid forcing one protocol until selection, layer sync, styling, benchmark, and marker ownership are settled in both apps                                                                                                                                                                                                                                             |
