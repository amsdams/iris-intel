...
| Add shared mock Intel/domain object builders                  | Open        | later add small deterministic builders for raw Intel response shapes and parsed domain objects such as entities, portal details, plexts, scores, inventory, artifacts, and ornaments; start with parser-contract fixtures, not Mini-IRIS pattern-mode topology or IRIS-specific debug UI flows                                                                                                                                                                                                       |
