...
| Refine viewport-scoped COMM cache and small-pan merge policy  | In Progress | shared current-window replacement rule now keeps IRIS and Mini-IRIS from carrying stale far-away COMM into fresh full-window fetches; later consider bounds/region buckets or small-pan append/merge so returning to a recent area can reuse local COMM history without showing unrelated regions                                                                                                                                                                                                 |
