...
| Address can disappear or break in diagnostics after smoke test          | Open   | observed after the latest IRIS runtime-message contract pass; verify diagnostics reverse-geocode/address state and whether invalid runtime-message filtering blocked an expected address update |
