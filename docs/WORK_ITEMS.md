...
| Test visible page-world map runtime interaction                          | Done   | PAGE VISIBLE exposes the page-world MapLibre runtime as a small floating pane; Chrome/Firefox desktop clicks return portal/link/field rendered-feature summaries, while Firefox mobile is testable with the status result and desktop mode |
