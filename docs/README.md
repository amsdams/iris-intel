...
- `docs/PAGE_WORLD_MAP_RUNTIME.md` is ignored locally; keep page-world migration status in `docs/WORK_ITEMS.md` unless
  the file is intentionally unignored and added later
