import { MissionDetails, MissionWaypoint } from '@iris/core';
import { MissionDetailsData, MissionWaypointPayload } from './types';
...
export function parseMissionDetails(data: MissionDetailsData): MissionDetails | null {
